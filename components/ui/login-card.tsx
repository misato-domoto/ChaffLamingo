    ...
    <div className='fixed inset-0 flex items-center justify-center p-4 bg-shuffle-tint'>
      <div className='relative flex h-fit flex-col rounded-md bg-card p-8 shadow-md sm:px-28'>
        ...
        <form className='text-center'>
            <div className='mb-4'>
                <input type='text' className='w-64 bg-shuffle-tint text-shuffle rounded-sm px-4 py-1' placeholder='メールアドレス'/>
            </div>
            <div className='mb-4'>
                <input type='password' className='w-64 bg-shuffle-tint text-shuffle rounded-sm px-4 py-1' placeholder='パスワード'/>
            </div>
            <button className='mb-3 bg-shuffle text-white rounded-sm px-6 py-1'>ログイン</button>
        </form>
